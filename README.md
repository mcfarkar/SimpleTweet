...
**Simple Tweet** is an android app that allows a user to view her Twitter timeline and post a new tweet. The app uses [Twitter REST API](https://dev.twitter.com/rest/public).
